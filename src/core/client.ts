...
export interface ClientConfig {
  ...
  /**
   * Controls the casing of field names in query results.
   *
   * - `camel` will convert snake case field names to camel case.
   * - `preserve` will leave field names as is.
   *
   * ⚠️ This must match the `generate.fieldCase` option in your pg-nano config.
   *
   * Note: While “runtime bindings” generated by pg-nano at compile time also
   * respect this option, direct calls to `Client#query` and other similar
   * methods will not. In those cases, your queries and their inputs must match
   * the casing used in the database schema.
   *
