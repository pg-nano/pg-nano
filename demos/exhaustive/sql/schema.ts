...
export const updateFoo = /* @__PURE__ */ bindQueryRow<updateFoo.Params, updateFoo.Result>("update_foo", [t.int4, t.update_mapper(t.text_array)], { update_foo: { address: t.address_type } })
